...
public class edit_activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = database.getReference("devices/device1/schedule/Schedule 2");
    ...
    private void showConfirmationDialog() {
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(edit_activity2.this, "Update/add canceled", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateSchedule(String updatedTimeOn, String updatedDateOn, String updatedTimeOff, String updatedDateOff) {
        ...
        Toast.makeText(edit_activity2.this, "Schedule updated successfully", Toast.LENGTH_SHORT).show();
