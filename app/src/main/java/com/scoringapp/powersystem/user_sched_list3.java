...
public class user_sched_list3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_sched_list3);
...
//                AlertDialog.Builder builder = new AlertDialog.Builder(user_sched_list3.this);
//
...
//                Intent intent = new Intent(user_sched_list3.this, schedule_activity.class);
